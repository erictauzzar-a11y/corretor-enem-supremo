...
A estrutura do checkout foi implementada como assinatura anual recorrente em modo `subscription`, com valor-alvo de 5390 centavos em BRL, equivalente a R$ 53,90. A criação do novo Price no Stripe permanece como etapa final após a liberação da conta.
