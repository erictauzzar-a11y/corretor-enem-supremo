      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-12 grid items-stretch gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <Card className="rounded-[24px] border-[#dfe5ff] bg-white shadow-[0_24px_70px_rgba(39,57,107,0.12)]">
            <CardHeader className="border-b border-[#eef0f6] px-7 pb-5 pt-7"><div className="flex items-center gap-2 text-[#3155d8]"><Crown className="h-5 w-5" /><span className="text-xs font-bold uppercase tracking-[0.18em]">AprovAI anual</span></div><CardTitle className="mt-3 text-3xl font-extrabold">R$ 37<span className="text-base font-semibold text-[#8891a6]"> / ano</span></CardTitle><p className="text-sm leading-6 text-[#66708a]">Renovação automática anual.</p></CardHeader>
