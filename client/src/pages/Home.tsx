...
const criteria = [
  { number: "01", title: "Domínio da modalidade escrita formal", text: "Avalia ortografia, acentuação, pontuação, concordância, regência, escolha vocabular e construção sintática. A nota considera a quantidade e a gravidade dos desvios." },
  { number: "02", title: "Compreensão da proposta e repertório", text: "Verifica se o participante desenvolve o tema, respeita o tipo dissertativo-argumentativo e mobiliza repertório sociocultural legítimo, pertinente e produtivo." },
  { number: "03", title: "Seleção e organização dos argumentos", text: "Analisa o projeto de texto: a seleção, a relação, a organização e a interpretação de informações, fatos, opiniões e argumentos em defesa do ponto de vista." },
  { number: "04", title: "Conhecimento dos mecanismos de coesão", text: "Observa o uso de recursos linguísticos para articular frases, períodos e parágrafos, estabelecendo relações de sentido com clareza e continuidade." },
  { number: "05", title: "Proposta de intervenção", text: "Avalia uma proposta para o problema abordado, com ação, agente, modo ou meio, efeito ou finalidade e detalhamento, sempre respeitando os direitos humanos." },
];
